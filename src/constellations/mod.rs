...
pub const NORTHERN_HEMISPHERE: &[(&str, &[usize])] = &[
    ...
    (
        ...
        &[
            ...
            50583, 50335, 48455, 47908, 0, 54872, 54879, 0, //
        ],
    ),
    (
        "Gemini",
    ...
    ("Lyra", &[91262, 91971, 92791, 93194, 92420, 91971]),
    (
        "Cygnus",
        &[
    ...
    ("Auriga", &[24608, 23453, 23015, 25428, 28380, 28360, 24608]),
    (
        "Taurus",
        &[
    ...
    (
        "Perseus",
        &[
            13268, 14328, 15863, 17358, 18532, 18614, 18246, 17448, 0, 13254, 14354, 14576, 15863,
        ],
    ),
    ("Triangulum", &[10064, 8796, 10670, 10064]),
    ("Aries", &[13209, 9884, 8903, 8832]),
    (
        "Pisces",
        &[
            5742, 6193, 4889, 5742, 7097, 8198, 9487, 8833, 7884, 7007, 4906, 1645, 118268, 116771,
            115830, 114971, 115738, 116928, 116771,
        ],
    ),
    ("Equuleus", &[104987, 105570, 104858, 104521, 104987]),
    ("Sagitta", &[98920, 98337, 97365, 96837, 0, 97365, 96757]),
    (
        "Delphinus",
    ...
    (
        "Aquarius",
        &[
            115438, 114855, 112961, 111497, 110960, 110395, 109074, 106278, 102618, 0, 114341,
            113136, 112716, 111123, 110003, 109074, 0, 109139, 109472, 110003,
        ],
    ),
    (
        "Hercules",
    ...
    (
        "Capricornus",
        &[
            107556, 106985, 105515, 104139, 100345, 100027, 0, 105515, 105881, 104139, 102978,
            0, //
            100345, 102485,
        ],
    ),
